    ...
    <footer className="bg-black text-gray-400 py-12">
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 px-4 sm:px-6 lg:px-8">
        <div>
          ...
          <p className="mb-4">
            We are passionate photographers and video editors, capturing moments
            with artistic precision and cinematic edits to transform your vision
            into stunning, timeless visual stories.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <p>Email: info.rkstudio4k@gmail.com</p>
          <p>Phone: +91 81404 44560</p>
        </div>
      </div>
      <p className="text-center text-xs pt-8">
        © 2025 RK Studio. All rights reserved.
      </p>
    </footer>
  );
}
